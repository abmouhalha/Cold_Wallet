...
def decrypt_private_key():
    try:
        # Lire la clé chiffrée depuis le fichier 'private_key.enc' dans le dossier 'keys'
        with open("Cold_Wallet/keys/private/private_key.enc", "rb") as file_in:
        ...
        encryption_key = input("Entrez la clé de chiffrement : ").encode()
